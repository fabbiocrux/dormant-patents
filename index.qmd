...
# Vosviewer: Landscape visualization  {#sci-vos background-image="figures/vos/10.jpg" background-size="65%" background-position="100% 50%" }
...
1. Open VOSviewer on your PC
1. Click on **`CREATE`** 
1. Add <br> **`Create a Map based on text data`** 
...
1. Select <br> **`Bibliographic database file`** 
...
1. Select <br> **`Web Of Science`** 

1. Seek your **`<Filename.txt>`**  on your PC 
...
1. Load your **`<Filename.txt>`**  on your PC 
...
1. Adjuts the <br> **`Number of Occurences`**  
