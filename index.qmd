...
- [Web Of Science Patent Database](#access)
...
# Vosviewer: Landscape visualization  {#sci-vos .unnumbered background-image="figures/vos/10.jpg" background-size="65%" background-position="100% 50%" }
